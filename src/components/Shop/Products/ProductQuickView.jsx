...
function ProductQuickView({ product, onClose, relatedProducts }) {
          ...
          <div className="flex-1 lg:w-1/2">
            ...
            <div className="mb-6 flex flex-col gap-3">
              <button
                ...
                className="bg-primaryColor hover:bg-primaryColor/90 w-full rounded-lg py-3 font-medium text-white transition"
              >
                Add to Cart
              </button>
