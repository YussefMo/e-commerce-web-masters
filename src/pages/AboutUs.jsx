const CioImg = [
    {
        Imgsrc: '/src/assets/images/CIO Manger.png',
        Title: 'CIO Manger'
    }
];
export default function AboutUs() {
  return (
    <>
      <div className="content-one flex flex-col items-center justify-center bg-gray-600 text-white text-center  shadow-md h-100">
      ...
      <div className="content-two mx-auto w-3/4">
        ...
        <div className="description-1">
            <p className="mb-6 mt-7">In nec purus eget neque accumsan finibus. 
                Duis condimentum elit ut libero commodo iaculis. 
                Donec augue diam, tristique et ultricies nec, consectetur quis enim. Nullam id 
            ...
            <p className="ml-7 mb-4">
                ...
                Aliquam a lectus id lacus rhoncus dapibus non ac justo. Vivamus lacinia vestibulum metus in dapibus. Vestibulum sit amet sollicitudin enim. Ut id interdum turpis. Curabitur porta auctor quam, 
                pretium facilisis nisl. Pellentesque efficitur elit ante, vel vulputate tortor blandit nec.
            </p>
        </div>

        <div className="relative flex flex-col md:flex-row justify-between gap-x-6 gap-y-6">
  ...
  <div className="title w-full md:w-1/2 flex flex-col justify-between">
    <p className="mb-4 mt-5 text-base font-medium">Rachel Leonard - Bacola CEO</p>

    <h2 className="font-bold mb-4 mt-5 text-2xl md:text-3xl leading-tight">
      Duis convallis luctus pretium. <br /> Pellentesque habitant morbi
    </h2>

    <p className="mb-6 mt-6 text-gray-700 leading-relaxed">
      Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
      incididunt ut labore et dolore magna aliqua. Quis ipsum suspendisse ultrices
      gravida. Risus commodo viverra maecenas accumsan lacus vel facilisis.
    </p>

    <p className="mb-7 mt-8 text-gray-700 leading-relaxed">
      ...
      eu efficitur orci. Praesent rutrum ante justo, eget malesuada ante ornare ac.
      Ut dignissim blandit urna, eget euismod leo rhoncus nec. Vestibulum ante ipsum
    ...
    <p className="relative  z-10 bg-white p-4 rounded shadow w-full mt-6  text-gray-800 leading-relaxed">
      ...
      non ac justo. Vivamus lacinia vestibulum metus in dapibus. Vestibulum sit amet
      sollicitudin enim. Ut id interdum turpis. Curabitur porta auctor quam,
      pretium facilisis nisl. Pellentesque efficitur elit ante, vel vulputate tortor
      blandit nec.
    </p>
  </div>
</div>
